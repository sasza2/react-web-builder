...
export const changesStartTransaction = (): Action<
	typeof CHANGES_START_TRANSACTION_TYPE
> => ({
	type: CHANGES_START_TRANSACTION_TYPE,
});

export const changesStopTransaction = (): Action<
	typeof CHANGES_STOP_TRANSACTION_TYPE
> => ({
