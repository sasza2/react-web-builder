...
export const isSeparator = (component: WebBuilderComponent) =>
	component.id === "Separator"; // TODO

export const isResizable = (component: WebBuilderComponent) =>
...
export const getElementPropsWhenCreating = (
	component: WebBuilderComponent,
	breakpoint: Breakpoint,
) =>
...
export const produceRenderForElement = (
	...
	const componentOfElement = components.find(
		(component) => component.id === element.componentName,
	);
	if (componentOfElement) {
		...
		const WebBuilderComponentRender = componentOfElement.component as React.FC<
			typeof props
		>;
...
export const getElementsBelowRow = (
	elements: WebBuilderElements,
	row: number,
): WebBuilderElements => elements.filter((element) => element.y > row);

export const getElementsAboveRow = (
	elements: WebBuilderElements,
	row: number,
): WebBuilderElements => elements.filter((element) => element.y < row);

export const getFirstElementBelowRow = (
	elements: WebBuilderElements,
	row: number,
): WebBuilderElement | null => {
...
export const groupElementsById = (
	elements: WebBuilderElements,
): Record<string, WebBuilderElement> => {
...
) => [WebBuilderComponentProperty, { autoFocus: boolean }]) => {
...
export const getElementFromList = (
...
export const getElementContainerIdProp = (
...
export const sortElements = (elements: WebBuilderElements) =>
	[...elements].sort((a, b) => {
