...
it("should strip event handler attributes", () => {
	const [result] = transform('<button onclick="alert(1)">Click me</button>', {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should apply classNamePrefix to class attribute", () => {
	const [result] = transform('<div class="foo bar">Test</div>', {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should strip out HTML comments", () => {
	const [result] = transform("<div><!-- secret stuff --><p>Visible</p></div>", {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should retain style but not remove elements with display:none (optional)", () => {
	const [result] = transform('<div style="display: none">Hidden</div>', {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should decode HTML entities correctly", () => {
	const [result] = transform("<p>Hello&nbsp;World &amp; Universe</p>", {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should gracefully handle unclosed tags", () => {
	const [result] = transform("<div><b>Bold<i>Italic</div>", {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should keep empty elements like <br>", () => {
	const [result] = transform("<p>Hello<br>World</p>", {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should preserve significant whitespace", () => {
	const [result] = transform("<pre>  line 1\n  line 2</pre>", {
		classNamePrefix: "builder",
		createNodeKey: () => "key",
	});
...
it("should ignore empty <style> tag", () => {
	const [result] = transform(
		"<style></style>" + '<div class="nav">Nav text</div>',
		{
			classNamePrefix: "builder",
			createNodeKey: () => "key",
		},
