...
describe("useSetElementsProgrammatic", () => {
	it("dispatches setElementsInBreakpointProgrammatic for the current breakpoint", () => {
		...
		const { result } = renderHook(() => useSetElementsProgrammatic(), {
			wrapper,
		});
