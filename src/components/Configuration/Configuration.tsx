...
export function Configuration() {
	...
	return (
		<>
			<SidebarHeader onBack={onBack}>{t("configuration.title")}</SidebarHeader>
			<SidebarScrollbar>
				<ConfigurationContainer>
					<FormGroup>
						<FormHeader>{t("configuration.autoSave.title")}</FormHeader>
						<FormProvider
					...
					<FormGroup>
						<FormHeader>{t("configuration.mouseWheel.title")}</FormHeader>
						<FormProvider
							getFormValues={getFormValues}
							setForm={setConfiguration}
						>
					...
					{configuration.panZoomScroll && (
						<FormGroup>
							...
							<FormProvider
								...
								setForm={setConfiguration}
							>
								<RangeSlider name="scrollSpeed" min={0} max={9} />
							</FormProvider>
						</FormGroup>
					)}
					<FormGroup>
						<FormHeader>{t("configuration.gridZooming.title")}</FormHeader>
						<FormProvider
							getFormValues={getFormValues}
							setForm={setConfiguration}
						>
					...
					<FormGroup>
						<FormHeader>{t("configuration.helpLines.title")}</FormHeader>
						<FormProvider
							getFormValues={getFormValues}
							setForm={setConfiguration}
						>
