...
// TODO - to helpers
const createColumnsFromBoard = (
	board: Array<Array<string>>,
): WebBuilderElements[] => {
	const elementsMap: Record<string, WebBuilderElement> = {};
	const columns: WebBuilderElements[] = board[0].map(
		() => [] as WebBuilderElements,
	);
...
it("cutBoard", () => {
	...
	).toStrictEqual(createColumnsFromBoard([["W"], ["W"], ["W"]]));
