...
export function Form({ errors, onClearBreakpoint, onSave }: FormProps) {
	...
	const renderPageSettingsLink = ({
		children,
	}: {
		children: JSX.Element | string;
	}) => <Clickable onClick={goToPageSettings}>{children}</Clickable>;

	return (
		<>
			<FormGroup>
				<FormHeader>{t("breakpoint.layout")}</FormHeader>
				<Input
