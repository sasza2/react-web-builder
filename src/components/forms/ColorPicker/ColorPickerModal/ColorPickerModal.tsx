...
export function ColorPickerModal({
	...
	return (
		...
		>
			<Container>
				{label && <FormHeader>{label}</FormHeader>}
				{allowGradient && (
					<>
						...
						<FlexHorizontal $gap="8px">
							...
							>
								...
								<Tooltip id={hexTooltipId} place="bottom">
									{t("color.types.hex")}
								</Tooltip>
							</ColorContainer>
							<ColorContainer
							...
							>
								...
								<Tooltip id={gradientTooltipId} place="bottom">
									{t("color.types.gradient")}
								</Tooltip>
							</ColorContainer>
						</FlexHorizontal>
					</>
				)}
				{allowGradient && type === ColorType.Gradient && (
					<GradientColorPicker setValue={setValue} value={value} />
				)}
				{type === ColorType.Hex && (
					<HexColorPicker
